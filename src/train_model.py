...
class Trainer(object):
    ...
    def train(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            for batch_idx in range(num_batches):
                ...
                outputs = self.model(node_elems, inp_elems, node_props, inp_props, max_prop_len)
                optimizer.zero_grad()
    ...
    def split_data(self, index=0):
        ...
        train_data_t_ent = np.repeat(self.train_data_t_ent, ceil(len(self.train_data_f_ent)/len(self.train_data_t_ent)), axis=0)
        self.train_data_t_ent = train_data_t_ent[:len(self.train_data_f_ent)].tolist()
    ...
    def optimize_threshold(self, model, val_data_t_ent, batch_size):
        ...
        global DIRECT_INPUTS, DIRECT_TARGETS,threshold_results
    ...
    def generate_input(self, elems, target, neighbours_dicts, emb_indexer):
        ...
        for elem in list(elems):
            try:
                ...
                print("Exception on generate_input")
